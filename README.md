...
| Тесты | `.venv/bin/python -m pytest`, 2723 |

Воспроизводимый прогон:

```bash
.venv/bin/pip install --require-hashes -r requirements-dev-lock.txt
.venv/bin/python -m pytest          # 2723 теста (прогон 2026-09-13)
```
...
19 786 байт и приблизительно **4 658 токенов** для четырёх схем Forms при
