...
| Тесты | `.venv/bin/python -m pytest`, 2745 |

Воспроизводимый прогон:

```bash
.venv/bin/pip install --require-hashes -r requirements-dev-lock.txt
.venv/bin/python -m pytest          # 2745 тестов (прогон 2026-09-13)
```
...
20 889 байт и приблизительно **4 933 токена** для четырёх схем Forms при
