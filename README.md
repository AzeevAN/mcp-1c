...
| Тесты | `.venv/bin/python -m pytest`, 2735 |

Воспроизводимый прогон:

```bash
.venv/bin/pip install --require-hashes -r requirements-dev-lock.txt
.venv/bin/python -m pytest          # 2735 тестов (прогон 2026-09-13)
```
...
20 252 байта и приблизительно **4 784 токена** для четырёх схем Forms при
