...
страницами, RLS раскрывается только отдельной кнопкой. Окно условия сохраняет
видимыми роль, объект и точное право, показывает число прочитанных символов и
добавляет каждое следующее окно до 2 000 символов к уже показанному тексту.
Состояния пустого
