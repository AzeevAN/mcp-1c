...
class Registry:
    ...
    def add_modules(self, path: str | Path, *, configuration: str) -> Source:
        ...
        # отказа ниже. Проверка после очистки означала бы, что ошибочное
        # нажатие сносит уже разобранные 351 МБ кода, а взять их заново неоткуда,
        # если гигабайтный архив из `incoming/` уже убран. Считаем по
        # центральному каталогу zip: тело архива не читается.
