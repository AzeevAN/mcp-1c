...
Источники рёбер:
    ...
    статическая декларация команды в Form.xml             -> общая команда
...
EDGE_TITLES = {
    ...
    "form_command": "общая команда формы",
    "subsystem_child": "дочерняя подсистема",
    "subsystem_contains": "входит в состав подсистемы",
}
