...
| Тесты | `.venv/bin/python -m pytest`, 2680 |

Воспроизводимый прогон:

```bash
.venv/bin/pip install --require-hashes -r requirements-dev-lock.txt
.venv/bin/python -m pytest          # 2680 тестов (прогон 2026-09-13)
```
...
переключатели, статические и связанные с данными надписи, кнопки,
...
17 438 байт и приблизительно **4 077 токенов** для четырёх схем Forms при
