...
| Тесты | `.venv/bin/python -m pytest`, 1778 |
...
Большую выгрузку конфигурации в файлы кладите в `incoming/`, не в
`bootstrap/`. Она разбирается по явной административной команде или из
дашборда и не блокирует каждый старт контейнера.
