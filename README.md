...
| Тесты | `.venv/bin/python -m pytest`, 2754 |

Воспроизводимый прогон:

```bash
.venv/bin/pip install --require-hashes -r requirements-dev-lock.txt
.venv/bin/python -m pytest          # 2754 теста (прогон 2026-09-13)
```
...
22 474 байта и приблизительно **5 370 токенов** для четырёх схем Forms при
