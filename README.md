...
`configuration`. Это имя в спецификацию и XML не попадает. Для групп доступны ориентация,
...
20 701 байт и приблизительно **4 905 токенов** для четырёх схем Forms при
