...
| Тесты | `.venv/bin/python -m pytest`, 2545 |

Воспроизводимый прогон:

```bash
.venv/bin/pip install --require-hashes -r requirements-dev-lock.txt
.venv/bin/python -m pytest          # 2545 тестов (прогон 2026-09-13)
```
...
11 690 байт и приблизительно **2 788 токенов** для четырёх схем Forms при
