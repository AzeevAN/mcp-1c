...
с документированными директивами и параметрами. События и команды отдельных
видов объекта пока остаются за границей контракта.
...
15 285 байт и приблизительно **3 529 токенов** для четырёх схем Forms при
